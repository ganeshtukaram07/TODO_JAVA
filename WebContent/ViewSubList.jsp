...
<div class="row2">
        ...
        <tbody>
        <%
        ResultSet rs=Dbconn.getResultFromSqlQuery("select * from addsublistinfo where username='"+session.getAttribute("unam")+"' and addlist='"+request.getParameter("addlist")+"'");
        while(rs.next())
        {
        %>
