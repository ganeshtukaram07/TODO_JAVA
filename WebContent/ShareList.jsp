...
<div class="row2">
  ...
  <form action="ShareListServlet" method="post">
        ...
        <tbody>
            <tr>
                ...
                <td>
<select name="sharelist">
<%
ResultSet rs=Dbconn.getResultFromSqlQuery("select * from register where uname!='"+session.getAttribute("unam")+"'");
while(rs.next())
{
%>
...
%>
             ...
             <tr><td colspan="2" align="right"><input type="submit" value="Share...." style="font-family: monotype corsiva;font-size: 22px;font-weight: bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
